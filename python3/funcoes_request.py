...
def checar_sc(valor, lista_sc):
    """Verifica se o status code está na lista"""
    return valor in lista_sc

def pegar_sc(posicao, lista_sc):
    """Retorna o status code pela posição"""
